// Reservation Datepicker 1.0       Powered by Yuri Loginov


var ReservationDatepicker = (function () {
    'use strict';
    ...
    var ReservationDatepicker = function ReservationDatepicker(input, options) {
        this._boundedEventHandlers = {};
        this.id = ReservationDatepicker.getNewId();
    ...
    ReservationDatepicker.prototype.addBoundedListener = function addBoundedListener(node, event, handler, capture) {
    ...
    ReservationDatepicker.prototype.getFirstValue = function getFirstValue() {
        var firstEl = document.getElementsByClassName('datepicker__month-day--first-day-selected')[0];
        if (firstEl == undefined || !isNaN(this.end)) {
            return '';
        }
        var time = parseInt(firstEl.getAttribute('time'), 10);
        var date = this.getDateString(time, 'YYYY-MM-DD');
        return date;
    }

    ReservationDatepicker.prototype.removeAllBoundedListeners = function removeAllBoundedListeners(node, event) {
        if (node in this._boundedEventHandlers) {
    ...
    ReservationDatepicker.getNewId = function getNewId() {
        return ++idCounter;
    };

    ReservationDatepicker.prototype.setFechaI18n = function setFechaI18n() {
    ...
    ReservationDatepicker.prototype.getWeekDayNames = function getWeekDayNames() {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.getMonthDom = function getMonthDom(month) {
        // Get month DOM element
        return document.getElementById(this.getMonthTableId(month));
    };

    ReservationDatepicker.prototype.getMonthName = function getMonthName(m) {
        // Get month name
        return this.lang('month-names')[m];
    };

    ReservationDatepicker.prototype.getDatepickerId = function getDatepickerId() {
        // Get datepicker ID
        return 'datepicker-' + this.generateId();
    };

    ReservationDatepicker.prototype.getMonthTableId = function getMonthTableId(month) {
        // Get month table ID
        return 'month-' + month + '-' + this.generateId();
    };

    ReservationDatepicker.prototype.getCloseButtonId = function getCloseButtonId() {
        // Get close button ID
        return 'close-' + this.generateId();
    };

    ReservationDatepicker.prototype.getTooltipId = function getTooltipId() {
        // Get close button ID
        return 'tooltip-' + this.generateId();
    };

    ReservationDatepicker.prototype.getNextMonth = function getNextMonth(month) {
        // Get next month date
    ...
    ReservationDatepicker.prototype.getPrevMonth = function getPrevMonth(month) {
    ...
    ReservationDatepicker.prototype.getDateString = function getDateString(date, format) {
    ...
    ReservationDatepicker.prototype.parseDate = function parseDate(date, format) {
        if (format === void 0) format = this.format;
    ...
    ReservationDatepicker.prototype.init = function init() {
        // DOM container
    ...
    ReservationDatepicker.prototype.addListeners = function addListeners() {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.generateId = function generateId() {
    ...
    ReservationDatepicker.prototype.createDom = function createDom() {
    ...
    ReservationDatepicker.prototype.createDatepickerDomString = function createDatepickerDomString() {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.showMonth = function showMonth(date, month) {
    ...
    ReservationDatepicker.prototype.createMonthDomString = function createMonthDomString(_date) {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.openDatepicker = function openDatepicker() {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.closeDatepicker = function closeDatepicker() {
    ...
    ReservationDatepicker.prototype.autoclose = function autoclose() {
    ...
    ReservationDatepicker.prototype.documentClick = function documentClick(evt) {
    ...
    ReservationDatepicker.prototype.datepickerHover = function datepickerHover(evt) {
    ...
    ReservationDatepicker.prototype.datepickerMouseOut = function datepickerMouseOut(evt) {
    ...
    ReservationDatepicker.prototype.checkAndSetDefaultValue = function checkAndSetDefaultValue() {
    ...
    ReservationDatepicker.prototype.setDateRange = function setDateRange(date1, date2) {
    ...
    ReservationDatepicker.prototype.showSelectedDays = function showSelectedDays() {
        var this$1 = this;
        ...
        for (var i = 0; i < days.length; i++) {
            ...
            document.getElementsByClassName('datepicker__month-day--first-day-selected-circle')[0] != undefined &&
                document.getElementsByClassName('datepicker__month-day--first-day-selected-circle')[0].parentElement == days[i] &&
                days[i].removeChild(document.getElementsByClassName('datepicker__month-day--first-day-selected-circle')[0]);

            document.getElementsByClassName('datepicker__month-day--first-day-selected-bg')[0] != undefined &&
                document.getElementsByClassName('datepicker__month-day--first-day-selected-bg')[0].parentElement == days[i] &&
                days[i].removeChild(document.getElementsByClassName('datepicker__month-day--first-day-selected-bg')[0]);

            document.getElementsByClassName('datepicker__month-day--last-day-selected-circle')[0] != undefined &&
                document.getElementsByClassName('datepicker__month-day--last-day-selected-circle')[0].parentElement == days[i] &&
                days[i].removeChild(document.getElementsByClassName('datepicker__month-day--last-day-selected-circle')[0]);

            document.getElementsByClassName('datepicker__month-day--last-day-selected-bg')[0] != undefined &&
                document.getElementsByClassName('datepicker__month-day--last-day-selected-bg')[0].parentElement == days[i] &&
                days[i].removeChild(document.getElementsByClassName('datepicker__month-day--last-day-selected-bg')[0]);
            ...
            if (this$1.start && this$1.getDateString(this$1.start, 'YYYY-MM-DD') === this$1.getDateString(time, 'YYYY-MM-DD')) {
                ...
                if (this.end && this.onSelectRange) {
                    var bgStartCircle = document.createElement('div');
                    bgStartCircle.className = 'datepicker__month-day--first-day-selected-circle';
                    days[i].prepend(bgStartCircle);
                    var bgStart = document.createElement('div');
                    bgStart.className = 'datepicker__month-day--first-day-selected-bg';
                    days[i].prepend(bgStart);
                }
            } else {
            ...
            if (this$1.end && this$1.getDateString(this$1.end, 'YYYY-MM-DD') === this$1.getDateString(time, 'YYYY-MM-DD')) {
                ...
                if (this.getValue() != undefined) {
                    var bgEndCircle = document.createElement('div');
                    bgEndCircle.className = 'datepicker__month-day--last-day-selected-circle';
                    days[i].prepend(bgEndCircle);
                    var bgEnd = document.createElement('div');
                    bgEnd.className = 'datepicker__month-day--last-day-selected-bg';
                    days[i].prepend(bgEnd);
                }
            } else {
    ...
    ReservationDatepicker.prototype.showSelectedInfo = function showSelectedInfo() {
    ...
    ReservationDatepicker.prototype.dayClicked = function dayClicked(day) {
    ...
    ReservationDatepicker.prototype.isValidDate = function isValidDate(time) {
    ...
    ReservationDatepicker.prototype.checkSelection = function checkSelection() {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.addDays = function addDays(date, days) {
        // Add xx days to date
    ...
    ReservationDatepicker.prototype.countDays = function countDays(start, end) {
        // Return days between two dates
        return Math.abs(this.daysFrom1970(start) - this.daysFrom1970(end)) + 1;
    };

    ReservationDatepicker.prototype.compareDay = function compareDay(day1, day2) {
    ...
    ReservationDatepicker.prototype.compareMonth = function compareMonth(month1, month2) {
    ...
    ReservationDatepicker.prototype.daysFrom1970 = function daysFrom1970(t) {
        // Get days from 1970
        return Math.floor(this.toLocalTimestamp(t) / 86400000);
    };

    ReservationDatepicker.prototype.toLocalTimestamp = function toLocalTimestamp(t) {
    ...
    ReservationDatepicker.prototype.printAttributes = function printAttributes(obj) {
    ...
    ReservationDatepicker.prototype.goToNextMonth = function goToNextMonth(e) {
    ...
    ReservationDatepicker.prototype.goToPreviousMonth = function goToPreviousMonth(e) {
    ...
    ReservationDatepicker.prototype.isSingleMonth = function isSingleMonth() {
        // Check if the second month is visible
        return !this.isVisible(this.getMonthDom(2));
    };

    ReservationDatepicker.prototype.isMonthOutOfRange = function isMonthOutOfRange(month) {
        var _m = new Date(month.valueOf());
    ...
    ReservationDatepicker.prototype.disableNextPrevButtons = function disableNextPrevButtons() {
    ...
    ReservationDatepicker.prototype.topBarDefaultText = function topBarDefaultText() {
        // Return early if the top bar is disabled
        if (!this.showTopbar) {
            return;
        }
    ...
    ReservationDatepicker.prototype.topBarErrorText = function topBarErrorText(bar, errorText, errorValue) {
        if (!this.showTopbar) {
            return;
        }
    ...
    ReservationDatepicker.prototype.updateSelectableRange = function updateSelectableRange() {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.dayHovering = function dayHovering(day) {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.clearHovering = function clearHovering() {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.clearSelection = function clearSelection() {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.parseDisabledDates = function parseDisabledDates() {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.getClosestDates = function getClosestDates(x) {
        var this$1 = this;
    ...
    ReservationDatepicker.prototype.lang = function lang(s) {
        // Return i18n string
        return (s in this.i18n) ? this.i18n[s] : '';
    };

    ReservationDatepicker.prototype.emptyElement = function emptyElement(element) {
    ...
    ReservationDatepicker.prototype.classRegex = function classRegex(c) {
        return new RegExp('(^|\\s+)' + c + '(\\s+|$)');
    };

    // Check if an element has a class
    ReservationDatepicker.prototype.hasClass = function hasClass(el, c) {
        return this.classRegex(c).test(el.className);
    };

    // Add a class to the element
    ReservationDatepicker.prototype.addClass = function addClass(el, c) {
    ...
    ReservationDatepicker.prototype.removeClass = function removeClass(el, c) {
        el.className = el.className.replace(this.classRegex(c), ' ');
    };

    ReservationDatepicker.prototype.isVisible = function isVisible(element) {
        // Check if a DOM element is visible
        return (element.offsetWidth || element.offsetHeight || element.getClientRects().length);
    };

    ReservationDatepicker.prototype.slideDown = function slideDown(element, speed) {
    ...
    ReservationDatepicker.prototype.slideUp = function slideUp(element, speed) {
        // Slide up an element
        var h = element.getBoundingClientRect().height;
        element.style.height = h + 'px';
        this.recalc(element.offsetHeight);
    ...
    ReservationDatepicker.prototype.recalc = function recalc(element) {
        // Force browser recalculation
        return element.offsetHeight;
    };

    ReservationDatepicker.prototype.isTouchDevice = function isTouchDevice() {
    ...
    ReservationDatepicker.prototype.open = function open() {
        this.openDatepicker();
    };

    ReservationDatepicker.prototype.close = function close() {
        this.closeDatepicker();
    };

    ReservationDatepicker.prototype.getDatePicker = function getDatePicker() {
        return this.datepicker;
    };

    ReservationDatepicker.prototype.setRange = function setRange(d1, d2) {
    ...
    ReservationDatepicker.prototype.clear = function clear() {
        this.clearSelection();
    };

    ReservationDatepicker.prototype.getNights = function getNights() {
        var count = 0;
    ...
    ReservationDatepicker.prototype.destroy = function destroy() {
